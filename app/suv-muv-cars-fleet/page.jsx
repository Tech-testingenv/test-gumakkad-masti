...
import { suvMuvCarsData } from '@/data/PackagesData'
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
                <VehicleSection
         Heading={suvMuvCarsData.Top.Heading}
           Paragraph={suvMuvCarsData.Top.Paragraph}
             data={Object.values(suvMuvCarsData.cars)}
                     />
          </div>
