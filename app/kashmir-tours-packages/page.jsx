...
export default function KashmirTourPackages() {
...
const kashmirPackages = [
  {
    category: "kashmir-tours-packages",
    slug : "paradise-kashmir-tour",
    image: "/assets/image/kashmir.jpg",
    title: "Paradise - Kashmir Tour",
    duration: "04 Nights / 05 Days",
    location: "Srinagar - Sonamarg - Pahalgam - Gulmarg",
    description: "Hotel, Breakfast, Transfer, Sightseeing & All Taxes.",
  },
  {
        category: "kashmir-tours-packages",

    slug : "classic-kashmir-package",
    image: "/assets/image/kashmir1.jpg",
    title: "Classic Kashmir Package",
  ...
  },
  {
    ...
    image: "/assets/image/kashmir2.jpg",
  ...
  return (
    ...
    <div className=" text-black py-16">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl font-bold mb-4">Kashmir Tour Packages</h1>
          <p className="text-xl  max-w-4xl mx-auto">
Kashmir Tour Packages offer a perfect escape into nature’s paradise, featuring scenic valleys, snow-covered mountains, serene lakes, and unforgettable experiences like Shikara rides, Gulmarg adventures, and peaceful stays in Pahalgam.
          </p>
        </div>
      </div>
