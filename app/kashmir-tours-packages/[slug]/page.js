...
export default function Page({ params }) {
  ...
  const allPackages = [
    { name: "Paradise - Kashmir Tour", slug: "paradise-kashmir-tour" },
    { name: "Classic Kashmir Package", slug: "classic-kashmir-package" },
    { name: "Kashmir Honeymoon Special", slug: "kashmir-honeymoon-special" },
  ]
            ...
            <ul className="text-sm space-y-2 text-blue-600">
              ...
              {allPackages
                ...
                .map((pkg, index) => (
                  <li key={index}>
                    <a
                      href={`/kashmir-tours-packages/${pkg.slug}`}
