...
export default function AndamanTourPackages() {
...
const andamanPackages = [
  {
        category: "andaman-packages",

    slug : "paradise-andaman-tour",
    image: "/assets/image/Andaman1.jpg",
    title: "Paradise - Andaman Tour",
    duration: "04 Nights / 05 Days",
    location: "Port Blair - Cellular Jail - Havelock Island - Radhanagar Beach",
    description: "Hotel, Breakfast, Transfer, Sightseeing & All Taxes.",
  },
  {
        category: "andaman-packages",

    slug : "classic-andaman-package",
    image: "/assets/image/Andaman2.jpg",
    title: "Classic Andaman Package",
    duration: "05 Nights / 06 Days",
    location: "Port Blair - Havelock Island - Neil Island - Laxmanpur Beach",
    description: "Stay, Breakfast, Transfers, Sightseeing & All Taxes Included.",
  },
  {
    category: "andaman-packages",
    slug : "andaman-honeymoon-special",
    image: "/assets/image/Andaman3.jpg",
    title: "Andaman Honeymoon Special",
    duration: "06 Nights / 07 Days",
    location: "Port Blair - Havelock Island - Neil Island - Elephant Beach",
  ...
  return (
    ...
    <div className=" text-black py-16">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl font-bold mb-4">Explore Exotic Andaman & Nicobar Tour Packages</h1>
          <p className="text-xl  max-w-4xl mx-auto">
Discover the tropical paradise of the Andaman & Nicobar Islands with our specially curated tour packages. From the historic Cellular Jail in Port Blair to the crystal-clear waters of Havelock Island and the serene beauty of Neil Island, enjoy a perfect island getaway. Relax on white sandy beaches, explore coral reefs, and experience unforgettable sunsets while enjoying comfortable stays and smooth travel arrangements.
          </p>
        </div>
      </div>
