...
export default function GoaTourPackages() {
...
const goaPackages = [
  {
    category: "goa-tour",
    slug: "paradise-goa-tour",
    image: "/assets/image/goa1.jpg",
    title: "Paradise - Goa Tour",
    duration: "04 Nights / 05 Days",
    location: "North Goa - Baga Beach - Calangute Beach - Fort Aguada",
    description: "Hotel, Breakfast, Transfer, Sightseeing & All Taxes.",
  },
  {
    category: "goa-tour",
    slug: "classic-goa-package",
    image: "/assets/image/goa2.jpg",
    title: "Classic Goa Package",
    duration: "05 Nights / 06 Days",
    location: "North Goa - South Goa - Dudhsagar Falls - Basilica of Bom Jesus",
    description: "Stay, Breakfast, Transfers, Sightseeing & All Taxes Included.",
  },
  {
    category: "goa-tour",
    slug: "goa-honeymoon-special",
    image: "/assets/image/goa3.jpg",
    title: "Goa Honeymoon Special",
    duration: "06 Nights / 07 Days",
    location: "North Goa - South Goa - Candolim Beach - Mandovi River Cruise",
  ...
  return (
    ...
    <div className=" text-black py-16">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl font-bold mb-4">Explore Vibrant Goa Tour Packages</h1>
          <p className="text-xl  max-w-4xl mx-auto">
Experience the lively charm of Goa with our specially curated tour packages. From the vibrant beaches of North Goa to the peaceful shores of South Goa, enjoy sun, sand, and unforgettable nightlife. Explore historic churches, stunning waterfalls, and relaxing river cruises while enjoying comfortable stays and seamless travel arrangements for the perfect beach getaway.
          </p>
        </div>
      </div>
