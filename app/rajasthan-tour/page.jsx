...
export default function RajasthanTourPackages() {
...
const rajasthanPackages = [
  {
    ...
    slug: "paradise-rajasthan-tour",
    image: "/assets/image/rajasthan.jpg",
    title: "Paradise - Rajasthan Tour",
  ...
  {
    category: "rajasthan-tour",
    slug: "classic-rajasthan-package",
    image: "/assets/image/rajasthan2.jpg",
    title: "Classic Rajasthan Package",
    duration: "05 Nights / 06 Days",
    location: "Jaipur - Jodhpur - Jaisalmer - Desert Safari",
    description: "Stay, Breakfast, Transfers, Sightseeing & All Taxes Included.",
  },
  {
    category: "rajasthan-tour",
    slug: "rajasthan-honeymoon-special",
    image: "/assets/image/rajasthan3.jpg",
    title: "Rajasthan Honeymoon Special",
    duration: "06 Nights / 07 Days",
    location: "Jaipur - Udaipur - Mount Abu - Lake Pichola",
  ...
  return (
    ...
    <div className=" text-black py-16">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl font-bold mb-4">Explore Royal Rajasthan Tour Packages</h1>
          <p className="text-xl  max-w-4xl mx-auto">
Experience the royal charm of Rajasthan with our specially crafted tour packages. From the majestic palaces of Jaipur and the blue city of Jodhpur to the golden dunes of Jaisalmer and the romantic lakes of Udaipur, discover the rich heritage and vibrant culture of this incredible destination. Enjoy desert safaris, historic forts, and luxurious stays for a truly unforgettable journey.
          </p>
        </div>
      </div>
