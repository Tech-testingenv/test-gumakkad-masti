...
export default function Page({ params }) {
  ...
  const allPackages = [
    { name: "Paradise - Shimla Manali Tour", slug: "paradise-shimla-manali-tour" },
    { name: "Classic Shimla Package", slug: "classic-shimla-package" },
    { name: "Shimla Manali Honeymoon Special", slug: "shimla-manali-honeymoon-special" },
  ]
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6 lg:sticky lg:top-24 h-fit">
          ...
          <EnquiryFormDetails  type="package"
            ...
            <ul className="text-sm space-y-2 text-blue-600">
              ...
              {allPackages
                ...
                .map((pkg, index) => (
                  <li key={index}>
                    <a
                      href={`/shimla-manali-tour/${pkg.slug}`}
