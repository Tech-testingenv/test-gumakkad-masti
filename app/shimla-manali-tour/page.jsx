...
export default function ShimlaTourPackages() {

  const [openModal, setOpenModal] = useState(false)
const [selectedPackage, setSelectedPackage] = useState("")
const shimlaPackages = [
  {
  category: "shimla-manali-tour",
    slug : "paradise-shimla-manali-tour",
    image: "/assets/image/simla.jpg",
    title: "Paradise - Shimla Manali Tour",
  ...
  },
  {
    ...
    slug : "classic-shimla-package",
    image: "/assets/image/simla3.jpg",
    title: "Classic Shimla Package",
    duration: "05 Nights / 06 Days",
    location: "Shimla - Kufri - Manali - Solang Valley",
    description: "Stay, Breakfast, Transfers, Sightseeing & All Taxes Included.",
  },
  {
      category: "shimla-manali-tour",

    slug : "shimla-manali-honeymoon-special",
    image: "/assets/image/simla2.jpg",
  ...
  return (
    ...
    <div className=" text-black py-16">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl font-bold mb-4">Explore Beautiful Shimla & Manali Tour Packages</h1>
          <p className="text-xl  max-w-4xl mx-auto">
Discover the charm of Shimla and Manali with our specially curated tour packages. From scenic hill views and lush green valleys to exciting adventures in Kufri and Solang Valley, experience the perfect blend of relaxation and thrill. Enjoy comfortable stays, smooth transfers, and unforgettable sightseeing as you explore one of India’s most loved hill destinations.
          </p>
        </div>
      </div>
