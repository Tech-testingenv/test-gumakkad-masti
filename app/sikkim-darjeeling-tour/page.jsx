...
const sikkimPackages = [
  {
    category: "sikkim-darjeeling-tour",
    slug: "paradise-sikkim-darjeeling-tour",
    image: "/assets/image/darjeeling1.jpg",
    title: "Paradise - Sikkim Darjeeling Tour",
    duration: "04 Nights / 05 Days",
    location: "Gangtok - Tsomgo Lake - Baba Mandir - Darjeeling",
    description: "Hotel, Breakfast, Transfer, Sightseeing & All Taxes.",
  },
  {
        category: "sikkim-darjeeling-tour",

    slug: "classic-sikkim-package",
    image: "/assets/image/darjeeling2.jpg",
    title: "Classic Sikkim Package",
    duration: "05 Nights / 06 Days",
    location: "Gangtok - Tsomgo Lake - Baba Mandir - Darjeeling - Tiger Hill",
    description: "Stay, Breakfast, Transfers, Sightseeing & All Taxes Included.",
  },
  {
        category: "sikkim-darjeeling-tour",

    slug: "sikkim-darjeeling-honeymoon-special",
    image: "/assets/image/darjeeling3.jpg",
    title: "Sikkim Honeymoon Special",
    duration: "06 Nights / 07 Days",
    location: "Gangtok - Lachung - Yumthang Valley - Darjeeling",
  ...
  return (
    ...
    <div className=" text-black py-16">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl font-bold mb-4">Explore Scenic Sikkim & Darjeeling Tour Packages</h1>
          <p className="text-xl  max-w-4xl mx-auto">
Experience the breathtaking beauty of Sikkim and Darjeeling with our specially designed tour packages. From the serene monasteries of Gangtok to the stunning landscapes of Tsomgo Lake and Yumthang Valley, enjoy a perfect blend of nature and adventure. Witness the magical sunrise at Tiger Hill and explore lush tea gardens in Darjeeling, all while enjoying comfortable stays and seamless travel arrangements.
          </p>
        </div>
      </div>
