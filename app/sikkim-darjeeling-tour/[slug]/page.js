...
const allPackages = [
  { name: "Paradise Sikkim Darjeeling Tour", slug: "paradise-sikkim-darjeeling-tour" },
  { name: "Classic Sikkim Package", slug: "classic-sikkim-package" },
  { name: "Sikkim Darjeeling Honeymoon Special", slug: "sikkim-darjeeling-honeymoon-special" },
]
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6 lg:sticky lg:top-24 h-fit">
          ...
          <EnquiryFormDetails  type="package"           destinationName={data.slug} />
            ...
            <ul className="text-sm space-y-2 text-blue-600">
              ...
              {allPackages
                ...
                .map((pkg, index) => (
                  <li key={index}>
                    <a
                      href={`/sikkim-darjeeling-tour/${pkg.slug}`}
