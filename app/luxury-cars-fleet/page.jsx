...
import { luxuryCarsData } from '@/data/PackagesData'
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <VehicleSection
Heading={luxuryCarsData.Top.Heading}
  Paragraph={luxuryCarsData.Top.Paragraph}
    data={Object.values(luxuryCarsData.cars)}
            />
          </div>
